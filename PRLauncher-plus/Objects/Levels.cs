...
namespace PRLauncher_plus.Objects {
    class Levels {
        ...
        private readonly static string[] doom_lvlArr = new string[] { "E1M1", "E1M2", "E1M3", "E1M4", "E1M5", "E1M6", "E1M7", "E1M8", "E1M9",
                                                                      "E2M1", "E2M2", "E2M3", "E2M4", "E2M5", "E2M6", "E2M7", "E2M8", "E2M9",
                                                                      "E3M1", "E3M2", "E3M3", "E3M4", "E3M5", "E3M6", "E3M7", "E3M8", "E3M9"};

        private readonly static string[] doomu_lvlArr = new string[] { "E1M1", "E1M2", "E1M3", "E1M4", "E1M5", "E1M6", "E1M7", "E1M8", "E1M9",
                                                                       "E2M1", "E2M2", "E2M3", "E2M4", "E2M5", "E2M6", "E2M7", "E2M8", "E2M9",
                                                                       "E3M1", "E3M2", "E3M3", "E3M4", "E3M5", "E3M6", "E3M7", "E3M8", "E3M9",
                                                                       "E4M1", "E4M2", "E4M3", "E4M4", "E4M5", "E4M6", "E4M7", "E4M8", "E4M9"};

        private readonly static string[] doom2_lvlArr = new string[] { "MAP01", "MAP02", "MAP03", "MAP04", "MAP05", "MAP06", "MAP07", "MAP08",
        ...
        public Levels (string wfn) {
            Init(wfn);
        }

        public void Init (string wfn) {

            if (wfn.Equals("doom1.wad"))
                ciwad = 0; // Doom 1
            else if (wfn.Equals("doom.wad") || wfn.Equals("doomu.wad"))
                ciwad = 1; // Ultimate Doom
            else if (wfn.Equals("doom2.wad") || wfn.Equals("plutonia.wad") || wfn.Equals("tnt.wad"))
                ciwad = 2; // Doom II / Final Doom

        }

        public string[] GetLevelList () {
            return levelsArr[ciwad];
        }

        public string ParseLevel (int index) {
